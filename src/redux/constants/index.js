export const ALLHOUSENFTS = 'ALLHOUSENFTS'
export const ALLMYNFTS = 'ALLMYNFTS'
...
export const HOME_NETWORK_CHANGE = 'HOME_NETWORK_CHANGE'
...
export const LABELPERCENTS='LABELPERCENTS'
export const HISTORYTYPES='HISTORYTYPES'
